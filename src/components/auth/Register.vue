      ...
      <v-form ref="form" fast-fail>
        <v-card-title class="text-center">
          ...
          <div
            ...
            @click="close(), reset(), (authStore.isRegisterDialogOpen = false)"
          >
        ...
        <v-card-text class="grid">
          ...
          <div>
            <v-text-field
              ...
              label="Mật khẩu"
              :rules="[rules.required, rules.min]"
              :append-inner-icon="visible.pass ? 'mdi-eye-off' : 'mdi-eye'"
          ...
          <div>
            <v-text-field
              ...
              :append-inner-icon="visible.config ? 'mdi-eye-off' : 'mdi-eye'"
              :type="visible.config ? 'text' : 'password'"
              variant="outlined"
              @click:append-inner="visible.config = !visible.config"
            ></v-text-field>
          </div>
          ...
          <div>
            <p class="text-center cursor-pointer">
              ...
              <a
                ...
                @click="close(), reset(), (authStore.isLoginDialogOpen = true)"
              >
                Đăng nhập
              </a>
            </p>
