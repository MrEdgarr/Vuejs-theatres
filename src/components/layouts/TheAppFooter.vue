<template>
  <v-footer class="d-flex flex-column !bg-gray-50">
    <v-container>
      <div class="!max-w-6xl m-auto md:p-0">
        <div class="grid grid-cols-12">
          <div class="md:col-span-3 col-span-12 sm:col-span-6 pb-5">
            ...
            <div class="cursor-pointer text-sm pt-2.5">
              <span class="hover:!text-sky-700 text-gray-500">
                Về Chúng Tôi
              </span>
            </div>
            <div class="cursor-pointer text-sm pt-2.5">
          ...
          <div class="md:col-span-3 col-span-12 sm:col-span-6 pb-5">
            ...
            <div class="cursor-pointer text-sm pt-2.5">
              <span class="hover:!text-sky-700 text-gray-500"> Góp Ý </span>
            </div>
            <div class="cursor-pointer text-sm pt-2.5">
              <span class="hover:!text-sky-700 text-gray-500">
                Rạp / Giá Vé
            ...
            <div class="cursor-pointer text-sm pt-2.5">
              <span class="hover:!text-sky-700 text-gray-500"> FAQ </span>
            </div>
          </div>
          <div class="md:col-span-3 col-span-12 sm:col-span-6 pb-5">
            <div>
              <h1 class="font-black text-3xl font-sans">LOGO</h1>
        ...
        <div class="pt-10">
          <h1 class="font-black text-3xl font-sans text-center">LOGO</h1>
